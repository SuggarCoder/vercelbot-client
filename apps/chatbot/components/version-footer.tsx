...
import type { Document } from "@/lib/central/contracts";
import { deleteDocumentAfter } from "@/lib/central/client";
      ...
      <div className="flex flex-row gap-4">
        <Button
          ...
          onClick={async () => {
            ...
            try {
              await deleteDocumentAfter(
                artifact.documentId,
                getDocumentTimestampByIndex(documents, currentVersionIndex),
              );
              await mutate(`/document?id=${artifact.documentId}`);
